...
struct Exercise12 : Drill
{
	...
	{
		// Exercise 1.
		Simple_window win{ Point{100, 100}, 800, 600, "Exercises 1-4 - Rectanlges, Howdy text, Initials, Tic-tac-toe" };
	...
	void Exercise5()
	{
		...
		Simple_window ex5_win{ Point{120, 120}, 300, 300, "Exercise 5 - Red frame" };
	...
	{
		// Exercise 6
		Simple_window unfitting_win{ Point{140, 140}, 1600, 1600, "Exercise 6 - Unfitting shape & window" };
	...
	{
		// Exercise 7
		Simple_window house_win{ Point(120, 120), 400, 400, "Exercise 7 - House drawing" };
	...
	void Exercise8()
	{// Exercise 8
		Simple_window olympic_win{ Point{160, 160}, 800, 500, "Exercise 8 - Olympic rings" };
